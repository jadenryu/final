        ...
        <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-md border-b">
          <div className="flex h-16 items-center gap-4 px-6">
            ...
            <div className="flex-1">
              <h1 className="text-xl playfair-semibold">Design Projects</h1>
            </div>
            <Button
        ...
        <main className="flex-1 p-6">
          ...
          <div className="space-y-4 mb-6">
              ...
              <div id="tutorial-filters" className="flex gap-2">
                ...
                <Select value={sortBy} onValueChange={setSortBy}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="papers">Component Count</SelectItem>
                  </SelectContent>
                </Select>
                ...
                <div id="tutorial-view-modes" className="flex border rounded-md">
                  <Button
                    ...
                    className={`rounded-r-none ${viewMode === "grid" ? "bg-teal-600 text-white hover:bg-teal-700" : ""}`}
                  >
                  ...
                  <Button
                    ...
                    className={`rounded-l-none ${viewMode === "list" ? "bg-teal-600 text-white hover:bg-teal-700" : ""}`}
                  >
            ...
            <div className="flex gap-4 text-sm text-gray-600">
              ...
              <span>•</span>
              <span>{filteredProjects.reduce((acc, p) => acc + p.papers.length, 0)} total components</span>
              <span>•</span>
            ...
            <Card className="text-center py-12">
              <CardContent>
                ...
                <p className="text-gray-600 mb-4 merriweather-light">
                  {searchQuery ? "Try adjusting your search terms" : "Create your first CAD project to get started"}
                </p>
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          <span>{project.papers.length} components</span>
                        </div>
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            <span className="flex items-center gap-1">
                              ...
                              {project.papers.length} components
                            </span>
                            {project.deadline && (
                              <span className="flex items-center gap-1">
