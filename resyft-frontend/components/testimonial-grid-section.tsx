...
const testimonials = [
  ...
  {
    quote:
      "The natural language interface is incredibly intuitive. I can iterate on designs 10x faster than traditional CAD software.",
    name: "Sarah Williams",
    company: "Boeing Design Team",
    avatar: "/placeholder.svg",
    type: "small-dark",
  },
  {
    quote:
      "As a mechanical engineer, the parametric control and precision of the AI-generated geometry impressed me. Professional-grade output every time.",
    name: "Dr. James Park",
  ...
  {
    quote:
      "The sketch-to-extrude workflow feels natural. I can describe 2D profiles and watch them become 3D solids in real-time.",
  ...
  {
    quote:
      "The real-time 3D visualization is stunning. I can inspect my designs from any angle and make adjustments through conversation.",
    name: "Lisa Thompson",
    company: "Dyson Engineering",
    avatar: "/placeholder.svg",
    type: "small-dark",
  },
  {
